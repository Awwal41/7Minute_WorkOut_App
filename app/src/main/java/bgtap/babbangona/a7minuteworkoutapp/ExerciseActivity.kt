...
import bgtap.babbangona.a7minuteworkoutapp.FinishActivity
import bgtap.babbangona.a7minuteworkoutapp.R
import bgtap.babbangona.a7minuteworkoutapp.adapter.ExerciseStatusAdapter
import bgtap.babbangona.a7minuteworkoutapp.constants.Constants
import bgtap.babbangona.a7minuteworkoutapp.databinding.ActivityExerciseBinding
import bgtap.babbangona.a7minuteworkoutapp.databinding.DialogCustomBackConfirmationBinding
import bgtap.babbangona.a7minuteworkoutapp.viewModel.ExerciseModel
import java.util.*
...
//variable
    ...
    private fun setupRestView() {
        ...
        try {
            val soundURI =
                Uri.parse("android.resource://bgtap.babbangona.a7_minutesworkoutapp/" + R.raw.press_start)
