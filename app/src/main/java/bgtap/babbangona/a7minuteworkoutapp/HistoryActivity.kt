...
import bgtap.babbangona.a7minuteworkoutapp.adapter.HistoryAdapter
import bgtap.babbangona.a7minuteworkoutapp.dao.HistoryDao
import bgtap.babbangona.a7minuteworkoutapp.databinding.ActivityHistoryBinding
        ...
        lifecycleScope.launch {
            historyDao.fetchALlDates().collect { allCompletedDatesList->
                ...
                if (allCompletedDatesList.isNotEmpty()) {
                    ...
                    val dates = ArrayList<ExerciseModel>()
...
private fun <E> ArrayList<E>.add(date: String) {
